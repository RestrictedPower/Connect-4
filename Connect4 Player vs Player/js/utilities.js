...
function isValidMove(slot, board){
  if(slot<0 || slot>=m || board[0][slot]!=0) return false;
  return true;
}
...
function displayTurn(firstTime){
  ...
  if(firstTime) infoLog("Game started!");
    ...
    infoLog("It took "+seconds+" seconds to make a move.");
  }
  infoLogAppend("It is "+color+"'s turn!");
